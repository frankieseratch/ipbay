...
(function () {
  var DICT = {
    en: {
      ...
      'home.press.eyebrow': 'As featured in',
      'home.press.headline': '“Dragon Ball Z Rep Yasuo Matsuo, Jun Matsuo and Frankie Seratch Launch IP Bay”',
      'home.press.cta': 'May 2026  ·  Read the article →',
    ...
    ja: {
      ...
      'home.press.eyebrow': '掲載メディア',
      'home.press.headline': '「『ドラゴンボールZ』代理人 松尾泰男・松尾ジュン・フランキー・セラッチ、日本の作家を欧米のスクリーンへ届けるIP Bayを発足」',
      'home.press.cta': '令和8年（2026）5月  ·  記事を読む →',
      'home.ch1.eyebrow': '船',
